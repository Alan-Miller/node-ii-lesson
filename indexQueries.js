...
app.get('/api/stuff', function (req, res, next) {
    ...
    // Queries are best for optional URLs. Default to queries
    // Params are best for super-specific stuff (e.g., IDs) or big-bucket stuff (e.g., category)

    //What are the keys for the following URLs, and what will their values be
